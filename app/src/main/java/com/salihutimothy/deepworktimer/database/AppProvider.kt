...
const val CONTENT_AUTHORITY = "com.salihutimothy.deepworktimer.provider"
...
class AppProvider: ContentProvider() {
    ...
    private fun buildUriMatcher() : UriMatcher {
        ...
        // e.g. content://com.salihutimothy.deepworktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)

        // e.g. content://com.salihutimothy.deepworktimer.provider/Tasks/8
